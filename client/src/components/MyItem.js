...
export default class myItem extends Component {
  ...
  deleteItem = (email,pname) => {
    ...
    Axios.put("/users/item/delete",{email:email,pname:pname})
      .then(response=>{
...
uploadHandler=(e)=>{
  ...
  updateItem =(id)=>{
    ...
    Axios.put("/users/item/update",body)
        .then(response=>{
            this.props.updateInventory();
            this.handleClose();
        });
  ...
  render() {
    ...
    const { user,img, pname, expect,mode,owneremail,_id,description} = this.props;
    return (
      <>
            ...
            <div className="group-btn">
              <OverlayTrigger overlay={<Tooltip id="tooltip">Edit</Tooltip>}>
                <span className="d-inline-block">
                  <button className="edit-btn" onClick={()=>{this.handleShow(true,img)}}>
                    <GiFairyWand />
                  </button>
                </span>
              </OverlayTrigger>
              <OverlayTrigger overlay={<Tooltip id="tooltip">Delete</Tooltip>}>
                <span className="d-inline-block">
                  <button className="delete-btn" onClick={()=>{this.handleShow(false,img)}}>
                    <GiSkullCrossedBones />
                  </button>
                </span>
              </OverlayTrigger>
      ...
      {this.state.edit?
        ...
        <ModalWrapper>
            ...
            <Modal.Body>
                        {/* <label htmlFor="basic-url">Information</label> */}
                            {/* {this.state.fieldArr.map((e,index)=>{
                              ...
                              <InputGroup  className="mb-3">
                                    ...
                                    <FormControl ref={input=>this.input0=input} defaultValue={pname} aria-describedby="basic-addon3" />
                                </InputGroup>
                                <InputGroup  className="mb-3">
                                    <InputGroup.Prepend>
                                    <InputGroup.Text id="basic-addon3" >
                                    ...
                                    <FormControl ref={input=>this.input1=input} defaultValue={expect} aria-describedby="basic-addon3" />
                                </InputGroup>
                                <InputGroup  className="mb-3">
                                    <InputGroup.Prepend>
                                    <InputGroup.Text id="basic-addon3" >
                                    ...
                                    <FormControl ref={input=>this.input2=input} defaultValue={mode} aria-describedby="basic-addon3" />
                                </InputGroup>
                              <InputGroup>
                                <InputGroup.Prepend>
                                <InputGroup.Text>description</InputGroup.Text>
                                </InputGroup.Prepend>
                                <FormControl ref={input=>this.input3=input} id="input3" as="textarea" defaultValue={description} aria-label="description"/>
                            </InputGroup>
                            <br/>
                            <label htmlFor="exampleFormControlFile1" className="select-btn">Choose An Image</label>
                            <input type="file" ref={myImage=>this.myImage=myImage} id="myImage" name="myImage" className="form-control-file" id="exampleFormControlFile1"/>
                            <Button variant="primary" className="upload-btn" onClick={this.uploadHandler}>Upload</Button>
                            <br/>
                        ...
                        <Button variant="primary" onClick={()=>{this.updateItem(_id)}}>
                            Submit
                        </Button>
                        </Modal.Footer>
          ...
          <Modal.Body>Are you sure to delete this item form your inventory?</Modal.Body>
          <Modal.Footer>
            <Button variant="secondary" onClick={this.handleClose}>
              Nope  
            </Button>
            <Button variant="primary" onClick={()=>this.deleteItem(owneremail,pname)}>
              Delete
            </Button>
          </Modal.Footer>
          </ModalWrapper>
