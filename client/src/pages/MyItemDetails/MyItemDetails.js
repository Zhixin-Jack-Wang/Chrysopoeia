...
export default class MyItemDetails extends Component {
  ...
  renderModal = ()=>{
    ...
    return (<Modal {...this.props.location.state} closeModal={this.closeModal}/>)
  }
  render() {
        const {user,pname,img,expect,mode,description} = this.props.location.state;
                ...
                <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                  ...
                  <div className="by">
                    <h4 className="text-title text-uppercase text-muted mt-3 mb-2">
                      posted by : <span className="text-uppercase">{user.name}</span>
                    </h4>
                  </div>
